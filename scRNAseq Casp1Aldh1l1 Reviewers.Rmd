...
pdf("cell_proportions.pdf",width=5,height=8)
ggplot(seurat_clustered_labeled@meta.data) +
    theme_classic() +
    theme(axis.text.x = element_text(color="#000000",size=12),
              axis.text.y = element_text(color="#000000", size=12),
    ...
    coord_flip() +
    geom_bar(aes(x=integrated_snn_res.0.4, 
                 fill=sample), 
                  position=position_fill()) + NoLegend()
dev.off()
